...
class CLPreviewViewController: CLBaseImagePickerViewController {
    ...
    func initConstraints() {
        ...
        self.customNavBars.addConstraints([
            NSLayoutConstraint.init(item: self.selectBtn, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.customNavBars, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: y),
            NSLayoutConstraint.init(item: self.selectBtn, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.customNavBars, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: -20)
            ])
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.customNavBars.addSubview(self.selectBtn)
