...
class IDPreviewViewController: CLBaseImagePickerViewController {
    ...
    func initConstraints() {
        ...
        self.customNavBars.addConstraints([
            NSLayoutConstraint.init(item: self.chooseView, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.customNavBars, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: y),
            NSLayoutConstraint.init(item: self.chooseView, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.customNavBars, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: -20)
            ])
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.toobar.alpha = 0
        self.customNavBars.navLine.isHidden = true
        self.backBtn.isHidden = false
        self.customNavBars.backgroundColor = UIColor(white: 0, alpha: 0.67)
        ...
        self.view.bringSubviewToFront(self.customNavBars)
        self.setselectimg()
        self.customNavBars.addSubview(self.chooseView)
        self.customNavBars.bringSubviewToFront(self.rightBtn)
